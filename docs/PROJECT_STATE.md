...
Last updated: 2026-02-11 (P2 complete)
...
## Current snapshot
- Active milestone: **P3 (world model overhaul + gene-level decoder)** per `docs/plan.md` v2.
- Completed milestones: M0, M1, M2 (from v1 roadmap), P1 (gene-token encoder + JEPA rewrite), P2 (perturbation encoding overhaul).
- Superseded milestones: M3 (ridge win insufficient; replaced by P3 usefulness gate), M4, M5 (replaced by P4–P7).
- Current focus: Implement world model architectures (attention-based, graph-conditioned, disentangled) + gene-level prediction decoder.
